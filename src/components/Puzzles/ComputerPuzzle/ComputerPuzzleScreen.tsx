...
export default function ComputerPuzzleScreen({
  ...
  return (
    <section className="bg-[#004f99] h-[50vh] flex items-center justify-center">
      <div className="flex items-center flex-col justify-center border-[#0161fc] border-2 w-full">
          ...
          >
            <div className="flex w-full flex-col gap-2">
              <div className="flex justify-between w-full items-center">
                <p>User name:</p>
                <p className="w-[60%] border-1 border-gray-400 pl-2 bg-white md:w-[70%]">
                  Michael Myers
                </p>
              </div>
              <div className="flex w-full items-center justify-between">
                ...
                <input
                  ...
                  className="border-1 border-gray-400 pl-2 w-[60%] bg-white md:w-[70%]"
                />
              </div>
            </div>
            ...
            <div className="flex gap-2 self-end w-full justify-end">
              <button
                type="submit"
                className="border-1 rounded-sm w-[50%] bg-white cursor-pointer hover:border-[#3f72b7] transition-all duration-150 hover:bg-gray-100 md:w-[25%]"
              >
                OK
              </button>
              <button
                type="button"
                className="border-1 border-gray-400 rounded-sm w-[50%] bg-white cursor-pointer transition-all duration-150 disabled:opacity-50 md:w-[25%]"
                disabled
              >
                Cancel
              </button>
